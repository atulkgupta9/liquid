/*
Package liquid is a pure Go implementation of Shopify Liquid templates, developed for use in https://github.com/atulkgupta9/gojekyll.

See the project README https://github.com/atulkgupta9/liquid for additional information and implementation status.
